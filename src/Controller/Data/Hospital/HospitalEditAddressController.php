...
use App\Form\Hospital\AddressType;
...
class HospitalEditAddressController extends AbstractController
{
    ...
    #[Route('/data/hospital/{id}/edit/address', name: 'app_data_hospital_edit_address', methods: ['GET', 'POST'], priority: 100)]
    ...
    public function __invoke(Request $request, Hospital $hospital): Response
    {
        ...
        return $this->render('data/hospital/edit_address.html.twig', [
            'hospital' => $hospital,
            'form' => $form,
        ]);
    }
